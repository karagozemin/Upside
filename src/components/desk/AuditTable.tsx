    ...
    <div className="panel overflow-hidden">
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-white/5 text-left text-[10px] uppercase tracking-wider text-[#767f8d]">
          ...
          <tbody>
            {entries.map((e) => (
              <tr key={e.id} className="border-b border-white/5 hover:bg-white/[0.02]">
                ...
                <td className="max-w-[200px] truncate px-5 py-3 text-xs text-[#767f8d]">{e.actionRecommended}</td>
